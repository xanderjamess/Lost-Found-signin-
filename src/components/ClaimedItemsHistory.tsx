    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-card p-6 bg-gradient-to-br from-primary/5 to-transparent border-primary/10">
          ...
          <p className="text-3xl font-bold text-slate-900">{historyTotal}</p>
          <p className="text-xs text-slate-500 font-medium mt-1">Items returned to owners</p>
        </div>

        <div className="glass-card p-6 bg-gradient-to-br from-accent/5 to-transparent border-accent/10">
          <div className="flex justify-between items-start mb-4">
            <div className="p-3 bg-accent/10 rounded-xl text-accent">
              <Zap size={24} />
            </div>
            <span className="text-[10px] font-bold text-accent bg-accent/5 px-2 py-1 rounded-full uppercase tracking-wider">
              Efficiency
            </span>
          </div>
          <p className="text-3xl font-bold text-slate-900">{recoveryRate}%</p>
          <p className="text-xs text-slate-500 font-medium mt-1">Recovery rate from reports</p>
        </div>

        <div className="glass-card p-6 bg-gradient-to-br from-emerald-500/5 to-transparent border-emerald-500/10">
          <div className="flex justify-between items-start mb-4">
          ...
          <p className="text-3xl font-bold text-slate-900">{claimsThisWeek}</p>
          <p className="text-xs text-slate-500 font-medium mt-1">New claims this week</p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="relative flex-grow max-w-md">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all font-medium text-sm"
              value={searchQuery}
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center space-x-2">
              ...
              <select 
                className="bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-xs font-bold text-slate-600 focus:outline-none"
      ...
      <div className="glass-card overflow-hidden">
                  ...
                  <tr key={item.id} className="hover:bg-slate-50/50 transition-colors group">
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <div className="relative">
                          ...
                          />
                          {item.isArchived && (
                            <div className="absolute -top-1 -right-1 bg-slate-500 text-white rounded-full p-0.5 shadow-sm">
                              <Archive size={8} />
                            </div>
                          )}
                        </div>
                        <div className="ml-4">
                          ...
                          <div className="flex flex-col mt-1 space-y-0.5">
                            <div className="flex items-center">
                              <span className="text-[9px] text-slate-400 uppercase font-black tracking-tighter mr-2">Ref: {item.id.toUpperCase()}</span>
                              <span className="px-1.5 py-0.5 bg-slate-100 text-slate-500 rounded text-[9px] font-bold uppercase tracking-wider">{item.category}</span>
                            </div>
                            {item.claimedBy && (
                              <div className="flex items-center">
                      ...
                      {claimer ? (
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-[10px] text-slate-400">{claimer.email}</p>
                          </div>
                        </div>
                      ) : (
                    ...
                    <td className="px-6 py-4 space-y-1">
                      <div className="flex items-center text-[10px] text-slate-500">
                        ...
                        <span className="font-medium mr-1.5 uppercase">Reported:</span>
                      ...
                      <div className="flex items-center text-[10px] text-primary">
                        ...
                        <span className="font-medium mr-1.5 uppercase">Claimed:</span>
                    ...
                    <td className="px-6 py-4">
                      {approver ? (
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-xs font-bold text-slate-700">{approver.name.split(' ')[0]}</span>
                        </div>
                      ) : (
                ...
                <tr>
                  <td colSpan={6} className="px-6 py-32 text-center">
                    <div className="max-w-xs mx-auto">
                      ...
                      <h3 className="text-slate-900 font-display font-bold mb-1">No claimed history found</h3>
                      <p className="text-slate-500 text-sm font-medium">Try adjusting your filters or search query to find specific records.</p>
                    </div>
                  </td>
                </tr>
              )}
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            <button className="px-4 py-2 bg-white border border-slate-200 rounded-lg text-[10px] font-bold text-slate-600 hover:bg-slate-50 transition-all uppercase tracking-widest shadow-sm">
